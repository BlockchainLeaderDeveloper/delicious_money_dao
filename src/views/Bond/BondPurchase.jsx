...
function BondPurchase({ bond, slippage, recipientAddress }) {
  ...
  const balance = trim(bond.balance, 4);
  let reward;
  let displayName;
  if (bond.isFour) {
    reward = "sDM";
              ...
              <div className="help-text">
                <em>
                  <Typography variant="body1" align="center" color="textSecondary">
                    First time bonding <b>{displayName}</b>? <br /> Please approve Sap Dao to use your{" "}
                    <b>{displayName}</b> for bonding.
                  </Typography>
                </em>
              </div>
            ) : (
              <FormControl className="sap-input" variant="outlined" color="primary" fullWidth>
