...
function Calculator() {
    ...
    const trimmedsHecBalance = trim(Number(ssapBalance), 4);
    const trimeMarketPrice = trim(marketPrice, 2);

    const [ssapAmount, setsHecAmount] = useState(trimmedsHecBalance);
    ...
    const calcInitialInvestment = () => {
        const ssap = Number(ssapAmount) || 0;
        const price = parseFloat(priceAtPurchase) || 0;
        const amount = ssap * price;
    ...
    }, [days, rewardYield, futureMarketPrice, ssapAmount]);
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={4} md={4} lg={4}>
                                        <Box className="calculator-card-apy">
                                            <Typography variant="h5" color="textSecondary">DM Price</Typography>
                                    ...
                                    <Grid item xs={6} sm={4} md={4} lg={4}>
                                        <Box className="calculator-card-index">
                                            <Typography variant="h5" color="textSecondary">Your sDM Balance</Typography>
                                            <Typography variant="h4">{isAppLoading ? <Skeleton width="100px" /> : <>{trimmedsHecBalance} sDM</>}</Typography>
                                        </Box>
                                    </Grid>
                                </Grid>
                            </Box>
                        ...
                        <Box className="calculator-card-area">
                            <Box>
                                    ...
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={6}>
                                            <Box className="calculator-card-action-area-inp-wrap">
                                                <Typography variant="h6">sDM Amount</Typography>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <Box className="calculator-card-action-area-inp-wrap">
                                                <Typography variant="h6">DM price at purchase ($)</Typography>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    className="calculator-card-action-input"
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <Box className="calculator-card-action-area-inp-wrap">
                                                <Typography variant="h6">Future DM market price ($)</Typography>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    className="calculator-card-action-input"
                                ...
                                <Box className="calculator-user-data">
                                    ...
                                    <Box className="data-row">
                                        <Typography>DM rewards estimation</Typography>
                                        <Typography>{isAppLoading ? <Skeleton width="80px" /> : <>{rewardsEstimation} DM</>}</Typography>
                                    </Box>
                                    <Box className="data-row">
