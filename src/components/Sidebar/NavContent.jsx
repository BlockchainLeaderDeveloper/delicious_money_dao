...
import { ReactComponent as SapIcon } from "../../assets/icons/sap-nav-header.svg";
import { ReactComponent as DelIcon } from "../../assets/icons/del-nav-header.svg";
          ...
          <Box className="branding-header">
            <Link href="/" target="_blank">
              <SvgIcon
                ...
                component={DelIcon}
                viewBox="0 0 181 161"
                style={{ minWdth: "180px", minHeight: "96px", width: "160px" }}
              />
              <div className="wallet-link f-32">Delicious Money</div>
            </Link>
            {address && (
