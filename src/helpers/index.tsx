...
export async function getMarketPrice({ networkID, provider }: IBaseAsyncThunk) {
  const dm_busd_address = dm_busd.getAddressForReserve(networkID);
  const pairContract = new ethers.Contract(dm_busd_address, PairContract, provider);
...
export async function getTokenPrice(tokenId = "sap-dao") {
